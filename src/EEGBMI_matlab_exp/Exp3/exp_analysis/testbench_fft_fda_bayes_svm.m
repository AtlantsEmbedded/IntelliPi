...
%                                                                                       *
%                 A FDA is applied to reduce the dimensionality and select the most     *
%                 pertinent linear transformation                                       *
%                                                                                       *
...
%                                                                                       *
%****************************************************************************************
function testbench_fft_fda_bayes_svm(dataset, normalize, window_length, trainset_proportion)
