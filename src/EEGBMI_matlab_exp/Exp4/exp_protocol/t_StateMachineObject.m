classdef t_StateMachineObject < handle
    ...
    properties (Constant)
        ...
        TASK_1_msg = 'Task: Plan right arm reach movement';
        TASK_2_msg = 'Task: Plan left arm reach movement';
    ...
    methods (Access = public)
        ...
        function StateMachineO = t_StateMachineObject()
            ...
            StateMachineO.psych_screen_active = 0;
            ...
            if StateMachineO.psych_screen_active
                StateMachineO.ScreenO = t_ScreenObject(0,StateMachineO.LogO);
            end
            
            StateMachineO.OpenBCIO = t_openbci();
        end
    ...
    methods (Access = private)
        ...
        function task_Prepare_ACT(StateMachineO)
            ...
            % start openBCI recording
            StateMachineO.OpenBCIO.record_trial(StateMachineO.trial_id, StateMachineO.timer_record/1000);
        ...
        function task_Buffer_ACT(StateMachineO)
            ...
            clc;
            fprintf('End of Trial ID: %f',StateMachineO.trial_id);
        ...
        function EndTrial_ACT(StateMachineO)
            ...
            if StateMachineO.trial_id == floor(StateMachineO.nb_of_record_trials/3) || StateMachineO.trial_id == floor(StateMachineO.nb_of_record_trials*2/3)
                ...
                clc;
                fprintf('Pause, press key when ready');
