function [ feature_vectors, baseline_vectors ] = fft_data( trials_data, baseline_data )
...
baseline_vectors = zeros(size(trials_data,1),featvec_length*4);
...
for ii=1:numel(trials_data)
    ...
    if nargout>1
        ...
        % reshape the feature vector
        baseline_vectors(ii,:) = reshape(Y',featvec_length*4,1);
    end
end
